...
class BMAddressbook
{
     ...
     * @return int
     */
    public function FindAddress($vorname, $nachname)
    {
        global $db;
     ...
     * @return array
     */
    public function GetAddressbook($letter, $groupID = -1, $sortColumn = 'nachname', $sortOrder = 'ASC', $groupByLetter = false)
    {
        global $db;
     ...
     * @return array
     */
    public function GetGroupList($contactID = 0)
    {
        global $db;
     ...
     * @return int
     */
    public function GroupAdd($title, $davURI = '', $davUID = '')
    {
        global $db;
     ...
     * @return bool
     */
    public function ContactGroup($contactID, $groupID)
    {
        global $db;
     ...
     * @return bool
     */
    public function DeContactGroup2($contactID, $groupID)
    {
        global $db;
        $groups = $this->GetGroupList();
