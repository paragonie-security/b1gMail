...
class VCardReader
{
     ...
     * @return array
     */
    private function _parseKeyField($key)
    {
        $return = [];
        $items = explode(';', $key);
        ...
        foreach ($items as $item) {
            ...
            if (isset($return['parameters'][$key])) {
                if (is_array($return['parameters'][$key])) {
                    ...
                    $return['parameters'][$key] = [$return['parameters'][$key], $value];
                }
            } else {
                $return['parameters'][$key] = $value;
            }
            ...
            if ($dPos !== false) {
                ...
                if ($key['name'] == 'N') {
                    ...
                    if (strtoupper($anrede) == 'MR.' || strtoupper($anrede) == 'MR') {
                        $anrede = 'herr';
                    } elseif (strtoupper($anrede) == 'MS.' || strtoupper($anrede) == 'MS'
                ...
                elseif ($key['name'] == 'TEL') {
                    ...
                    } elseif (eqOrIn($key['parameters']['TYPE'], 'FAX')) {
