...
class BMPOP3Gateway
{
     ...
     */
    public function ProcessMails($maxMails = -1)
    {
        global $bm_prefs;
        ...
        foreach ($mailList as $mailNum => $mailInfo) {
            ...
            // process mail
            $mailProcessor = _new('BMMailProcessor', [$tempFileFP]);
     ...
     * @return bool
     */
    public function ConnectToPOP3Box()
    {
        global $bm_prefs;

        // connect
        $this->_pop3 = _new('BMPOP3', [$bm_prefs['pop3_host'], $bm_prefs['pop3_port']]);
