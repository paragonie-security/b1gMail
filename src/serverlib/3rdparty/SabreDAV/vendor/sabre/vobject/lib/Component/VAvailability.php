...
class VAvailability extends VObject\Component {
     ...
     * @return (int|string)[]
     *
     * @psalm-return array{UID: 1, DTSTAMP: 1, BUSYTYPE: '?', CLASS: '?', CREATED: '?', DESCRIPTION: '?', DTSTART: '?', 'LAST-MODIFIED': '?', ORGANIZER: '?', PRIORITY: '?', SEQUENCE: '?', SUMMARY: '?', URL: '?', DTEND: '?', DURATION: '?', CATEGORIES: '*', COMMENT: '*', CONTACT: '*'}
     */
