...
class VEvent extends VObject\Component {
     ...
     * @return (int|string)[]
     *
     * @psalm-return array{UID: 1, DTSTAMP: 1, DTSTART: '1'|'?', CLASS: '?', CREATED: '?', DESCRIPTION: '?', GEO: '?', 'LAST-MODIFIED': '?', LOCATION: '?', ORGANIZER: '?', PRIORITY: '?', SEQUENCE: '?', STATUS: '?', SUMMARY: '?', TRANSP: '?', URL: '?', 'RECURRENCE-ID': '?', RRULE: '?', DTEND: '?', DURATION: '?', ATTACH: '*', ATTENDEE: '*', CATEGORIES: '*', COMMENT: '*', CONTACT: '*', EXDATE: '*', 'REQUEST-STATUS': '*', 'RELATED-TO': '*', RESOURCES: '*', RDATE: '*'}
     */
