 ...
 */
function keyValue(Reader $reader, $namespace = null): array {
 ...
 */
function enum(Reader $reader, $namespace = null): array {
 ...
 */
function repeatingElements(Reader $reader, $childElementName): array {
