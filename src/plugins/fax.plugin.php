...
class FaxPlugin extends BMPlugin
{
	...
	function OnReadLang(&$lang_user, &$lang_client, &$lang_custom, &$lang_admin, $lang): void
	{
		...
		if($lang == 'deutsch')
		{
			$_lang_admin['modfax_prefixes']				= 'Vorwahlen';
			$_lang_admin['modfax_fpdferror']			= 'FPDF/FPDI ist nicht installiert, wird aber vom Fax-Plugin zwingend zum Versand von Faxen ben&ouml;tigt. Bitte lesen Sie die Fax-Plugin-Dokumentation, um zu erfahren, wie Sie FPDF/FPDI installieren.';
			$_lang_admin['modfax_protocol']				= 'Einlieferungsweg';
			$_lang_admin['modfax_email']				= 'E-Mail';
			$_lang_admin['modfax_http']					= 'HTTP-POST';
			$_lang_admin['modfax_emailfrom']			= 'E-Mail von';
			$_lang_admin['modfax_emailto']				= 'E-Mail an';
			$_lang_admin['modfax_emailsubject']			= 'E-Mail-Betreff';
			$_lang_admin['modfax_emailtext']			= 'E-Mail-Text';
			$_lang_admin['modfax_emailpdffile']			= 'Anhang-Dateiname';
			$_lang_admin['modfax_httpurl']				= 'URL';
			$_lang_admin['modfax_httprequest']			= 'POST-Request';
			$_lang_admin['modfax_numberformat']			= 'Nummern-Format';
			$_lang_admin['modfax_number_internat_00']	= 'International mit 00 (z.B. 004912345678)';
			$_lang_admin['modfax_number_internat_plus']	= 'International mit + (z.B. +4912345678)';
			$_lang_admin['modfax_number_internat_none']	= 'International ohne Prefix (z.B. 4912345678)';
			$_lang_admin['modfax_number_nat']			= 'Ohne internat. Vorwahl (z.B. 012345678)';
			$_lang_admin['modfax_supportsstatus']		= 'Status-Nachricht';
			$_lang_admin['modfax_signatures']			= 'Signaturen';
			$_lang_admin['modfax_status1']				= 'Antwort-E-Mail';
			$_lang_admin['modfax_status2']				= 'HTTP-Push';
			$_lang_admin['modfax_statuscode_from']		= 'Status-Code';
			$_lang_admin['modfax_success_from']			= 'Erfolgs-Bedingung';
			$_lang_admin['modfax_statuscode_param']		= 'Status-Code-Parameter';
			$_lang_admin['modfax_result_param']			= 'Ergebnis-Parameter';
			$_lang_admin['modfax_advancedmode']			= 'Erweiterter Modus';
			$_lang_admin['modfax_gateways_advanced']	= 'Gateways (erweiterter Modus)';
			$_lang_admin['modfax_gateways_simple']		= 'Gateways (vereinfachter Modus)';
			$_lang_admin['modfax_country_prefix']		= 'Landes-Vorwahl';
			$_lang_admin['modfax_prefix']				= 'Vorwahl';
			$_lang_admin['modfax_price_firstpage']		= 'Preis (erste Seite)';
			$_lang_admin['modfax_price_nextpages']		= 'Preis (weitere Seiten)';
			$_lang_admin['modfax_forbidno']				= 'Nummern-Bereich verbieten';
			$_lang_admin['modfax_addprefix']			= 'Vorwahl hinzuf&uuml;gen';
			$_lang_admin['modfax_signature']			= 'Signatur';
			$_lang_admin['modfax_used']					= 'Verwendet';
			$_lang_admin['modfax_addsignature']			= 'Signatur hinzuf&uuml;gen';
			$_lang_admin['modfax_fontsize']				= 'Schriftgr&ouml;&szlig;e';
			$_lang_admin['modfax_style']				= 'Stil';
			$_lang_admin['modfax_bold']					= 'Fett';
			$_lang_admin['modfax_italic']				= 'Kursiv';
			$_lang_admin['modfax_underlined']			= 'Unterstrichen';
			$_lang_admin['modfax_fontname']				= 'Schriftart';
			$_lang_admin['modfax_align']				= 'Ausrichtung';
			$_lang_admin['modfax_alignleft']			= 'Linksb&uuml;ndig';
			$_lang_admin['modfax_alignright']			= 'Rechtsb&uuml;ndig';
			$_lang_admin['modfax_aligncenter']			= 'Zentriert';
			$_lang_admin['modfax_alignjustify']			= 'Blocksatz';
			$_lang_admin['modfax_line']					= 'Trenn-Linie';
			$_lang_admin['modfax_top']					= 'Oben';
			$_lang_admin['modfax_bottom']				= 'Unten';
			$_lang_admin['modfax_showon']				= 'Anzeigen auf';
			$_lang_admin['modfax_placement']			= 'Platzierung';
			$_lang_admin['modfax_margin']				= 'Reservierte H&ouml;he';
			$_lang_admin['modfax_firstpage']			= '1. Seite';
			$_lang_admin['modfax_otherpages']			= 'Weitere Seiten';
			$_lang_admin['modfax_faxtoday']				= 'Gesendete Faxe (heute)';
			$_lang_admin['modfax_faxmonth']				= 'Gesendete Faxe (dieser Monat)';
			$_lang_admin['modfax_faxall']				= 'Gesendete Faxe (insgesamt)';
			$_lang_admin['modfax_creditstoday']			= 'Abgerechnete Cred. (heute)';
			$_lang_admin['modfax_creditsmonth']			= 'Abgerechnete Cred. (dieser Monat)';
			$_lang_admin['modfax_creditsall']			= 'Abgerechnete Cred. (insgesamt)';
			$_lang_admin['modfax_refundstoday']			= 'R&uuml;ckerstattungen (Cred., heute)';
			$_lang_admin['modfax_refundsmonth']			= 'R&uuml;ckerstattungen (Cred., dieser Monat)';
			$_lang_admin['modfax_refundsall']			= 'R&uuml;ckerstattungen (Cred., insgesamt)';
			$_lang_admin['modfax_errtoday']				= '&Uuml;bertragungs-Fehler (heute)';
			$_lang_admin['modfax_errmonth']				= '&Uuml;bertragungs-Fehler (dieser Monat)';
			$_lang_admin['modfax_errall']				= '&Uuml;bertragungs-Fehler (insgesamt)';
			$_lang_admin['modfax_perms']				= 'Berechtigungen';
			$_lang_admin['modfax_refund_on_error']		= 'R&uuml;ckerstattung bei Fehler';
			$_lang_admin['modfax_fromname']				= 'Absender-Name';
			$_lang_admin['modfax_fromno']				= 'Absender-Nr.';
			$_lang_admin['modfax_allow_ownno']			= 'Eigene Absender-Nr.';
			$_lang_admin['modfax_allow_ownname']		= 'Eigener Absender-Name';
			$_lang_admin['modfax_allow_pdf']			= 'PDF-Anh&auml;nge';
			$_lang_admin['modfax_faxes']				= 'Faxe';
			$_lang_admin['modfax_credits']				= 'Credits';
			$_lang_admin['modfax_stat_1']				= 'Gesendete Faxe';
			$_lang_admin['modfax_stat_2']				= 'Erfolgreiche Übermittlungen';
			$_lang_admin['modfax_stat_3']				= 'Fehlerhafte Übermittlungen';
			$_lang_admin['modfax_stat_4']				= 'Abgerechnete Credits';
			$_lang_admin['modfax_stat_5']				= 'Zurückerstattete Credits';
			$_lang_admin['modfax_faxtpl']				= 'Fax-Vorlage';
			$_lang_admin['modfax_block']				= 'Block';
			$_lang_admin['modfax_textblock']			= 'Text-Block';
			$_lang_admin['modfax_pagebreak']			= 'Seitenumbruch';
			$_lang_admin['modfax_cover']				= 'Deckblatt (Kopf)';
			$_lang_admin['modfax_pdffile']				= 'PDF-Anhang';

			$_lang_user['modfax_txrefundtext']			= 'Rückerstattung (Fax-Versand fehlgeschlagen)';
			$_lang_user['modfax_txtext']				= 'Fax-Versand';
			$_lang_user['modfax_fax']					= 'Fax';
			$_lang_user['modfax_send']					= 'Fax senden';
			$_lang_user['modfax_outbox']				= 'Journal';
			$_lang_user['modfax_fromno']				= 'Absender-Nummer';
			$_lang_user['modfax_fromname']				= 'Absender-Name';
			$_lang_user['modfax_next']					= 'Weiter';
			$_lang_user['modfax_fontname']				= 'Schriftart';
			$_lang_user['modfax_textblock']				= 'Text-Block';
			$_lang_user['modfax_pagebreak']				= 'Seitenumbruch';
			$_lang_user['modfax_cover']					= 'Deckblatt (Kopf)';
			$_lang_user['modfax_pdffile']				= 'PDF-Anhang';
			$_lang_user['modfax_fontsize']				= 'Schriftgr&ouml;&szlig;e';
			$_lang_user['modfax_style']					= 'Stil';
			$_lang_user['modfax_bold']					= 'Fett';
			$_lang_user['modfax_italic']				= 'Kursiv';
			$_lang_user['modfax_underlined']			= 'Unterstrichen';
			$_lang_user['modfax_file']					= 'Datei';
			$_lang_user['modfax_browse']				= 'Ausw&auml;hlen';
			$_lang_user['modfax_pages']					= 'Seiten';
			$_lang_user['modfax_preview']				= 'Vorschau und Preis-Berechnung';
			$_lang_user['modfax_align']					= 'Ausrichtung';
			$_lang_user['modfax_alignleft']				= 'Linksb&uuml;ndig';
			$_lang_user['modfax_alignright']			= 'Rechtsb&uuml;ndig';
			$_lang_user['modfax_aligncenter']			= 'Zentriert';
			$_lang_user['modfax_alignjustify']			= 'Blocksatz';
			$_lang_user['modfax_nofilesel']				= 'Noch keine Datei gew&auml;hlt';
			$_lang_user['modfax_browsetext']			= 'Bitte w&auml;hlen Sie die PDF-Datei aus, die Sie an Ihr Fax anh&auml;ngen m&ouml;chten. Sie k&ouml;nnen eine Datei von Ihrem Computer oder von Ihrer Webdisk (falls vorhanden) ausw&auml;hlen.';
			$_lang_user['modfax_pdferror']				= 'Die Datei ist keine gültige PDF-Datei oder verschlüsselt/geschützt.';
			$_lang_user['modfax_pdfpageerror']			= 'Die PDF-Datei konnte aus unbekannten Gründen nicht verarbeitet werden.';
			$_lang_user['modfax_remark']				= 'Vermerk';
			$_lang_user['modfax_remark0']				= 'Dringend';
			$_lang_user['modfax_remark1']				= 'Bitte um Antwort';
			$_lang_user['modfax_remark2']				= 'Bitte um Stellungnahme';
			$_lang_user['modfax_remark3']				= 'Zur Durchsicht';
			$_lang_user['modfax_remark4']				= 'Zur Kenntnisnahme';
			$_lang_user['modfax_previewtext']			= 'Ihr Fax wurde erfolgreich zum Versand vorbereitet. Im Folgenden k&ouml;nnen Sie eine Vorschau (PDF-Datei) des Faxes herunterladen und Sie sehen die Seitenanzahl des Faxes sowie den Preis (in Credits), der bei Versand f&auml;llig wird.';
			$_lang_user['modfax_previewtext2']			= 'Wenn Sie das Fax absenden m&ouml;chten, klicken Sie bitte auf &quot;Fax senden&quot;. Stellen Sie vorher sicher, dass Ihr Credit-Guthaben zum Versand ausreicht.';
			$_lang_user['modfax_toerr']					= 'Die angegebene Empf&auml;nger-Nummer ist ung&uuml;ltig. Bitte pr&uuml;fen Sie Ihre Eingabe und versuchen Sie es erneut.';
			$_lang_user['modfax_toforbiddenerr']		= 'Es k&ouml;nnen leider keine Faxe an die angegebene Nummer bzw. an die angegebene Vorwahl gesendet werden.';
			$_lang_user['modfax_sent']					= 'Das Fax wurde erfolgreich verschickt.';
			$_lang_user['modfax_sendfailed']			= 'Das Fax konnte nicht gesendet werden. M&ouml;gliche Ursache ist ein zu kleines Guthaben oder ein tempor&auml;rer interner Fehler. Bitte versuchen Sie es sp&auml;ter erneut.';
			$_lang_user['modfax_sentfolder']			= 'Gesendete Faxe';
			$_lang_user['modfax_status1']				= 'Wird gesendet';
			$_lang_user['modfax_status2']				= 'Versendet';
			$_lang_user['modfax_status3']				= 'Fehler';
			$_lang_user['modfax_refunded']				= 'zur&uuml;ckerstattet';
			$_lang_user['modfax_filena']				= 'nicht mehr vorhanden';
			$_lang_user['modfax_browsepdf']				= 'PDF-Datei ausw&auml;hlen';
			$_lang_user['modfax_fromerr']				= 'Der angegebene Absender-Name bzw. die angegebene Absender-Nummer ist ung&uuml;ltig. Bitte pr&uuml;fen Sie Ihre Eingabe und versuchen Sie es erneut.';

			$_lang_client['modfax_browsepdf']			= 'PDF-Datei ausw&auml;hlen';
		}
		...
		{
			$_lang_admin['modfax_prefixes']				= 'Prefixes';
			$_lang_admin['modfax_fpdferror']			= 'FPDF/FPDI is not installed properly, but is required by the Fax plugin to create faxes. Please read the documentation of the Fax plugin on how to install FPDF/FPDI.';
			$_lang_admin['modfax_protocol']				= 'Submit protocol';
			$_lang_admin['modfax_email']				= 'E-mail';
			$_lang_admin['modfax_http']					= 'HTTP-POST';
			$_lang_admin['modfax_emailfrom']			= 'E-mail from';
			$_lang_admin['modfax_emailto']				= 'E-mail tio';
			$_lang_admin['modfax_emailsubject']			= 'E-mail subject';
			$_lang_admin['modfax_emailtext']			= 'E-mail text';
			$_lang_admin['modfax_emailpdffile']			= 'Attachment file name';
			$_lang_admin['modfax_httpurl']				= 'URL';
			$_lang_admin['modfax_httprequest']			= 'POST-Request';
			$_lang_admin['modfax_numberformat']			= 'Number format';
			$_lang_admin['modfax_number_internat_00']	= 'International with 00 (e.g. 004912345678)';
			$_lang_admin['modfax_number_internat_plus']	= 'International with + (e.g. +4912345678)';
			$_lang_admin['modfax_number_internat_none']	= 'International without 00/+ (e.g. 4912345678)';
			$_lang_admin['modfax_number_nat']			= 'Without internat. prefix (e.g.. 012345678)';
			$_lang_admin['modfax_supportsstatus']		= 'Status report';
			$_lang_admin['modfax_signatures']			= 'Signatures';
			$_lang_admin['modfax_status1']				= 'Reply e-mail';
			$_lang_admin['modfax_status2']				= 'HTTP push';
			$_lang_admin['modfax_statuscode_from']		= 'Status code';
			$_lang_admin['modfax_success_from']			= 'Success condition';
			$_lang_admin['modfax_statuscode_param']		= 'Status code parameter';
			$_lang_admin['modfax_result_param']			= 'Status parameter';
			$_lang_admin['modfax_advancedmode']			= 'Advanced mode';
			$_lang_admin['modfax_gateways_advanced']	= 'Gateways (simplified mode)';
			$_lang_admin['modfax_gateways_simple']		= 'Gateways (advanced mode)';
			$_lang_admin['modfax_country_prefix']		= 'Country prefix';
			$_lang_admin['modfax_prefix']				= 'Prefix';
			$_lang_admin['modfax_price_firstpage']		= 'Price (first page)';
			$_lang_admin['modfax_price_nextpages']		= 'Price (further pages)';
			$_lang_admin['modfax_forbidno']				= 'Forbid';
			$_lang_admin['modfax_addprefix']			= 'Add prefix';
			$_lang_admin['modfax_signature']			= 'Signature';
			$_lang_admin['modfax_used']					= 'Used';
			$_lang_admin['modfax_addsignature']			= 'Add signature';
			$_lang_admin['modfax_fontsize']				= 'Font size';
			$_lang_admin['modfax_style']				= 'Style';
			$_lang_admin['modfax_bold']					= 'Bold';
			$_lang_admin['modfax_italic']				= 'Italic';
			$_lang_admin['modfax_underlined']			= 'Underlined';
			$_lang_admin['modfax_fontname']				= 'Font family';
			$_lang_admin['modfax_align']				= 'Alignment';
			$_lang_admin['modfax_alignleft']			= 'Left';
			$_lang_admin['modfax_alignright']			= 'Right';
			$_lang_admin['modfax_aligncenter']			= 'Center';
			$_lang_admin['modfax_alignjustify']			= 'Justify';
			$_lang_admin['modfax_line']					= 'Line';
			$_lang_admin['modfax_top']					= 'Top';
			$_lang_admin['modfax_bottom']				= 'Bottom';
			$_lang_admin['modfax_showon']				= 'Show on';
			$_lang_admin['modfax_placement']			= 'Placement';
			$_lang_admin['modfax_margin']				= 'Reserved height';
			$_lang_admin['modfax_firstpage']			= '1. page';
			$_lang_admin['modfax_otherpages']			= 'Further pages';
			$_lang_admin['modfax_faxtoday']				= 'Sent faxes (today)';
			$_lang_admin['modfax_faxmonth']				= 'Sent faxes (current month)';
			$_lang_admin['modfax_faxall']				= 'Sent faxes (overall)';
			$_lang_admin['modfax_creditstoday']			= 'Charged credits (today)';
			$_lang_admin['modfax_creditsmonth']			= 'Charged credits (current month)';
			$_lang_admin['modfax_creditsall']			= 'Charged credits (overall)';
			$_lang_admin['modfax_refundstoday']			= 'Refunds (credits, today)';
			$_lang_admin['modfax_refundsmonth']			= 'Refunds (credits, current month)';
			$_lang_admin['modfax_refundsall']			= 'Refunds (credits, overall)';
			$_lang_admin['modfax_errtoday']				= 'Transmission errors (today)';
			$_lang_admin['modfax_errmonth']				= 'Transmission errors (current month)';
			$_lang_admin['modfax_errall']				= 'Transmission errors (overall)';
			$_lang_admin['modfax_perms']				= 'Permissions';
			$_lang_admin['modfax_refund_on_error']		= 'Refund on error';
			$_lang_admin['modfax_fromname']				= 'Sender name';
			$_lang_admin['modfax_fromno']				= 'Sender no';
			$_lang_admin['modfax_allow_ownno']			= 'Own sender no';
			$_lang_admin['modfax_allow_ownname']		= 'Own sender name';
			$_lang_admin['modfax_allow_pdf']			= 'PDF attachments';
			$_lang_admin['modfax_faxes']				= 'Faxes';
			$_lang_admin['modfax_credits']				= 'Credits';
			$_lang_admin['modfax_stat_1']				= 'Sent faxes';
			$_lang_admin['modfax_stat_2']				= 'Successful transmissions';
			$_lang_admin['modfax_stat_3']				= 'Failed transmissions';
			$_lang_admin['modfax_stat_4']				= 'Charged credits';
			$_lang_admin['modfax_stat_5']				= 'Refunded credits';
			$_lang_admin['modfax_faxtpl']				= 'Fax template';
			$_lang_admin['modfax_block']				= 'Block';
			$_lang_admin['modfax_textblock']			= 'Text block';
			$_lang_admin['modfax_pagebreak']			= 'Page break';
			$_lang_admin['modfax_cover']				= 'Cover page (head)';
			$_lang_admin['modfax_pdffile']				= 'PDF attachment';

			$_lang_user['modfax_txrefundtext']			= 'Refund (failed to send fax)';
			$_lang_user['modfax_txtext']				= 'Fax';
			$_lang_user['modfax_fax']					= 'Fax';
			$_lang_user['modfax_send']					= 'Send fax';
			$_lang_user['modfax_outbox']				= 'Outbox';
			$_lang_user['modfax_fromno']				= 'Sender no';
			$_lang_user['modfax_fromname']				= 'Sender name';
			$_lang_user['modfax_next']					= 'Next';
			$_lang_user['modfax_fontname']				= 'Font family';
			$_lang_user['modfax_textblock']				= 'Text block';
			$_lang_user['modfax_pagebreak']				= 'Page break';
			$_lang_user['modfax_cover']					= 'Cover page (head)';
			$_lang_user['modfax_pdffile']				= 'PDF attachment';
			$_lang_user['modfax_fontsize']				= 'Font size';
			$_lang_user['modfax_style']					= 'Style';
			$_lang_user['modfax_bold']					= 'Bold';
			$_lang_user['modfax_italic']				= 'Italic';
			$_lang_user['modfax_underlined']			= 'Underlined';
			$_lang_user['modfax_file']					= 'File';
			$_lang_user['modfax_browse']				= 'Chose';
			$_lang_user['modfax_pages']					= 'Pages';
			$_lang_user['modfax_preview']				= 'Preview and price calculation';
			$_lang_user['modfax_align']					= 'Alignment';
			$_lang_user['modfax_alignleft']				= 'Left';
			$_lang_user['modfax_alignright']			= 'Right';
			$_lang_user['modfax_aligncenter']			= 'Center';
			$_lang_user['modfax_alignjustify']			= 'Justify';
			$_lang_user['modfax_nofilesel']				= 'No file selected';
			$_lang_user['modfax_browsetext']			= 'Please select the PDF file you would like to attach to your fax. You can chose a file from your computer or from your webdisk (if available).';
			$_lang_user['modfax_pdferror']				= 'The file is not in PDF format or encrypted/protected.';
			$_lang_user['modfax_pdfpageerror']			= 'The PDF file could not be processed for unknown reasons.';
			$_lang_user['modfax_remark']				= 'Remark';
			$_lang_user['modfax_remark0']				= 'Urgent';
			$_lang_user['modfax_remark1']				= 'Please Reply';
			$_lang_user['modfax_remark2']				= 'Please Comment';
			$_lang_user['modfax_remark3']				= 'For Review';
			$_lang_user['modfax_remark4']				= 'For Your Information';
			$_lang_user['modfax_previewtext']			= 'Your fax has been prepared for sending. Here you can download the preview for your fax (PDF file) and you can see the page count and price (in credits) of your fax.';
			$_lang_user['modfax_previewtext2']			= 'If you would like to send the fax, click at &quot;Send fax&quot;. Please ensure that you have enough credits first.';
			$_lang_user['modfax_toerr']					= 'The recipient no is invalid. Please check your input and try again.';
			$_lang_user['modfax_toforbiddenerr']		= 'Unfortunately we cannot process faxes to this number at this time.';
			$_lang_user['modfax_sent']					= 'The fax has been sent successfuly.';
			$_lang_user['modfax_sendfailed']			= 'The fax could not been sent. Possible causes are too less credits or a temporary internal problem. Please try again later.';
			$_lang_user['modfax_sentfolder']			= 'Sent faxes';
			$_lang_user['modfax_status1']				= 'Sending';
			$_lang_user['modfax_status2']				= 'Sent';
			$_lang_user['modfax_status3']				= 'Error';
			$_lang_user['modfax_refunded']				= 'refunded';
			$_lang_user['modfax_filena']				= 'not available anymore';
			$_lang_user['modfax_browsepdf']				= 'Select PDF file';
			$_lang_user['modfax_fromerr']				= 'The sender name/no is invalid. Please check your input and try again.';

			$_lang_client['modfax_browsepdf']			= 'Select PDF file';
		}
